'''
Author: waysolong
Date: 2023-01-14 18:12:43
LastEditTime: 2023-01-14 20:17:54
LastEditors: waysolong
Description: 
FilePath: /workspace/detectron2/tools/deploy/detectron2/create_onnx.py
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--exported_onnx", default="output/model.onnx", help="The exported to ONNX Detectron 2 Mask R-CNN", type=str)
    parser.add_argument("-o", "--onnx", default="output/model_new.onnx", help="The output ONNX model file to write", type=str)
    parser.add_argument("-c", "--det2_config", default="configs/COCO-Detection/faster_rcnn_R_50_FPN_3x.yaml", help="The Detectron 2 config file (.yaml) for the model", type=str)
    parser.add_argument("-w", "--det2_weights", help="The DetectroInstanceSegmentationnt", default="models/model_final_280758.pkl")
    parser.add_argument("-s", "--sample_image", default="sample.jpg", type=str, help="sample image for input")
    parser.add_argument("-b", "--batch_size", help="Batch size for the model", type=int, default=1)
    parser.add_argument("-t1", "--first_nms_threshold", help="Override the score threshold for the 1st NMS operation", type=float, default=0.3)
    parser.add_argument("-t2", "--second_nms_threshold", help="Override the score threshold for the 2nd NMS operation", type=float, default=0.3)
